...
runJS(function() {
    ...
    var STYLE =
        ...
        'span.oclb-giving {background-image:url(' + R_GIVING_IMG + ')}' +
        'span.oclb-already{background-image:url(' + R_ALREADY_IMG + ');background-size:auto 8px}' +
        'span.oclb-success{background-image:url(' + R_SUCCESS_IMG + ')}' +
        'span.oclb-error  {background-image:url(' + R_ERROR_IMG + ')}' +
        'span.oclb-spam   {background-image:url(' + R_SPAM_IMG + ');background-size:auto 21px}' +
        'span.oclb-unknown{background-image:url(' + R_UNKNOWN_IMG + ')}',
