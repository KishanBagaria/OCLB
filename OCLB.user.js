...
runJS(function() {
    var
        ...
        ENOUGH_IMG = 'data:image/gif;base64,',
        ...
        R_SPAM_IMG = 'data:image/png;base64,',
        R_ENOUGH_IMG = 'data:image/gif;base64,',
    ...
    var STYLE =
        ...
        'span.oclb-enough {background:url(' + ENOUGH_IMG + ') center no-repeat}' +
        ...
        'span.oclb-enough {background-image:url(' + R_ENOUGH_IMG + ') center no-repeat}',
        ...
        var addLlamaButton = function(devNameLink) {
            ...
            if (devName) {
                ...
                if (devName !== loggedInDev) {
                    ...
                    } else if (_includes(HAS_100K_LLAMAS, devName)) {
